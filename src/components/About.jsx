        ...
        <div className="container">
            <div className="row align-items-center justify-content-center">
                ...
                <div className="title">ABOUT OXFORD HACK</div>
                    ...
                    <p className="main-text">
                        This event is partnered with <a href="https://mlh.io/">Major League Hacking</a>. We’ll be following MLH’s Code of Conduct, which you can find <a href="https://static.mlh.io/docs/mlh-code-of-conduct.pdf">here</a>.
                    </p>
                </div>
