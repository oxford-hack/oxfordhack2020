...
const RegisterButton = () => {
    ...
    return (
      <div>
        {isDesktop ? (
            <a className="first" href="https://app.oxfordhack.co.uk" 
              style={{flexShrink: 0, marginRight: '10px', color: '#f3b24f'}}>
              <p className="element"> Register here! </p>
            </a>
        ) : (
        <div>
